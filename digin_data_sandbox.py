...
data1 = np.fromfile('/Users/emmabarash/Desktop/emma_behavioral_dat/eb18_behavior_3_2_240302_114243/board-DIGITAL-IN-01.dat', dtype = np.dtype('uint16'))
data2 = np.fromfile('/Users/emmabarash/Desktop/emma_behavioral_dat/eb18_behavior_3_2_240302_114243/board-DIGITAL-IN-02.dat', dtype = np.dtype('uint16'))
csum = pd.DataFrame()
csum['AnID'] = digin_files[0][-55:-51]
csum['suc'] = data0
csum['nacl_low'] = data1
csum['nacl_high'] = data2

csum = csum.groupby(['AnID']).suc.sum()
csum = csum.groupby(['AnID']).nacl_low.sum()
csum = csum.groupby(['AnID']).nacl_high.sum()
